                      ...
                      <table class="table table-striped table-bordered" id="covid-data">
						...
						<?php foreach($information as $row=>$val){?>
							<tr> 
								...
								<td  class="text-center"> <a href="<?php echo site_url("users/coviddata/contact_tracing?id=".$val->listID);?>"><button class="btn btn-primary btn-md"> <i class="fas fa-user-friends"></i> CONTACT TRACING </button></a></td>
							</tr>
						<?php } ?>
						</tbody>
                      </table>
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
						<form  method="post" action="<?php echo site_url('add-new-data');?>">
											<div class="form-row">
