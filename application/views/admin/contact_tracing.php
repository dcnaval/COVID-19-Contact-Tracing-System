                      ...
                      <table class="table table-striped table-bordered" id="covid-data">
						...
						<?php foreach($information as $row=>$val){?>
							<tr> 
								...
								<td  class="text-center"><button class="btn btn-warning btn-md"  data-toggle="modal" data-target="#removedata<?php echo $val->tracingID ;?>"> REMOVE </button></td>
							</tr>
								<!-- REMOVE USER ACCOUNT -->
								<div class="modal fade" id="removedata<?php echo $val->tracingID ;?>" tabindex="-1" role="dialog"
									  ...
									  <div class="modal-dialog modal-dialog-centered" role="document">
										<div class="modal-content">
										  ...
										  <div class="modal-body">
											<form  method="post" action="<?php echo site_url('remove-tracing');?>">
											 <input type="hidden" class="form-control" name="tracingID" value="<?php echo $val->tracingID;?>" required>
	   ...
	   <div class="modal fade" id="addnewdata" tabindex="-1" role="dialog"
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
						<form  method="post" action="<?php echo site_url('add-new-tracing-data-admin');?>">
											<div class="form-row">
